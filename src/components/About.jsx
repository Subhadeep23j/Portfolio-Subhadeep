       ...
       {/* Education Section */}
        <div className="mt-16 text-center px-4">
            ...
            <div className="grid md:grid-cols-3 gap-10">
                ...
                <AnimatedSection delay={0.4}>
                  <div className="relative group p-8 rounded-2xl bg-white/10 backdrop-blur-md shadow-2xl border border-purple-500 transition-transform duration-300 hover:scale-105 h-full flex flex-col min-h-[320px]">
                      {/* University Logo */}
                ...
                <AnimatedSection delay={0.5}>
                  <div className="relative group p-8 rounded-2xl bg-white/10 backdrop-blur-md shadow-2xl border border-blue-500 transition-transform duration-300 hover:scale-105 h-full flex flex-col min-h-[320px]">
                      {/* School Logo */}
                      <div className="absolute -top-10 left-1/2 transform -translate-x-1/2">
                          <img 
                              src={HS} 
                ...
                <AnimatedSection delay={0.6}>
                  <div className="relative group p-8 rounded-2xl bg-white/10 backdrop-blur-md shadow-2xl border border-green-500 transition-transform duration-300 hover:scale-105 h-full flex flex-col min-h-[320px]">
                      {/* School Logo */}
                      <div className="absolute -top-10 left-1/2 transform -translate-x-1/2">
                          <img 
                              src={MP} 
        ...
        <div className="mt-16 text-center px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Frontend Skills */}
            <AnimatedSection delay={0.3}>
              <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-purple-500/30 hover:border-purple-500 transition-all duration-300 group h-full flex flex-col min-h-[300px]">
            ...
            {/* React Development */}
            <AnimatedSection delay={0.4}>
              <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-blue-500/30 hover:border-blue-500 transition-all duration-300 group h-full flex flex-col min-h-[300px]">
            ...
            {/* UI/UX Design */}
            <AnimatedSection delay={0.5}>
              <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-pink-500/30 hover:border-pink-500 transition-all duration-300 group h-full flex flex-col min-h-[300px]">
            ...
            {/* Backend Development */}
            <AnimatedSection delay={0.6}>
              <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-green-500/30 hover:border-green-500 transition-all duration-300 group h-full flex flex-col min-h-[300px]">
            ...
            <AnimatedSection delay={0.7}>
              <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-yellow-500/30 hover:border-yellow-500 transition-all duration-300 group h-full flex flex-col min-h-[300px]">
